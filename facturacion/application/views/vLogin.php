...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>TECNOACCES</b>DIGITAL</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="<?php echo base_url();?>index.php/CLogin/ingresar" method="POST">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" id="txtUsu" name="txtUsuario" placeholder="Nombre Usuario">
    ...
    <a href="<?= site_url('CLogin/ingresar');?>">Olvide mi contraseña</a><br>
