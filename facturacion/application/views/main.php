...
<!--<![endif]-->
	<head>
	    ...
	    <link rel="stylesheet" href="<?php echo base_url();?>assets/css/one-page.css">
		    ...
		    <!-- Collect the nav links, forms, and other content for toggling -->
			    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav navbar-right">
						...
						<li><a href="<?php echo base_url();?>index.php/Cempresa">empresas</a></li>
						<li><a href="<?php echo base_url();?>index.php/Ccliente">clientes</a></li>
	...
	<section class="service" id="service">
		<div class="container">
			<div class="_section-wrapper">
				...
				<div class="row">
					<div class="">
						<img src="<?php echo base_url();?>assets/images/service.png" alt="service" class="service-img img-responsive">
					</div>
		...
		<div class="container section-wrapper">
			...
			<div class="row">
				...
				<div class="col-sm-4 col-xs-6">
					<div class="portfolio-item">
						<div class="portfolio-img">
							<img src="<?php echo base_url();?>assets/images/port-5.png" alt="port-5" class="port-item">
							<div class="portfolio-img-hover">
								<a href="#"><img src="<?php echo base_url();?>assets/images/plus.png" alt="plus" class="plus"></a>
							</div> <!-- /.portfolio-img-hover -->
						</div> <!-- /.portfolio-img -->
				...
				<div class="col-sm-4 col-xs-6">
					<div class="portfolio-item">
						<div class="portfolio-img">
							<img src="<?php echo base_url();?>assets/images/port-6.png" alt="port-6" class="port-item">
							<div class="portfolio-img-hover">
								<a href="#"><img src="<?php echo base_url();?>assets/images/plus.png" alt="plus" class="plus"></a>
							</div> <!-- /.portfolio-img-hover -->
						</div> <!-- /.portfolio-img -->
